...
Three tiers, enforced at the gateway — not by convention:
...
- The 1M-context boot failure was never root-caused (evidence destroyed by
  the rollback — that's the point of the postmortem).
